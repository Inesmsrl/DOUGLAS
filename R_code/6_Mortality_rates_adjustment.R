...
export(MR_adj_USA_M, here("results", "FADNES_2022_repro", "MR", "MR_adjusted_USA_M.csv"))
export(MR_adj_EU_W, here("results", "FADNES_2022_repro", "MR", "MR_adjusted_EU_W.csv"))
...
export(simulations_summary_mr_adjusted_USA_M, here("results", "FADNES_2022_repro", "MR", "simulations_summary_mr_adjusted_USA_M.csv"))
export(simulations_summary_mr_adjusted_EU_W, here("results", "FADNES_2022_repro", "MR", "simulations_summary_mr_adjusted_EU_W.csv"))
